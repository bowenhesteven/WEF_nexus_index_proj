...
source(paste0(proj_root, "/R/Sensitivity_Analysis.R"))
source(paste0(proj_root, "/R/Uncertainty_Analysis.R"))
...
p1 <- ggplot(UA_df, aes(x=Median, y=CV*100)) +
  ...
  ggtitle("WEF ranking vs Coefficient of Variance (CV)") + xlab("Median rank of WEF Index") + ylab("Coefficient of Variance (%)") + 
  theme_classic() + 
...
p2 <- ggplot(UA_df, aes(x=Median, y=interval)) +
  ...
  ggtitle("WEF ranking vs Confidence Interval (CI)") + xlab("Median rank of WEF Index") + ylab("Confidence Inverval (95%)") + 
  theme_classic() + 
  theme(plot.title = element_text(size=18, face="bold", hjust = 0.5), axis.title.x = element_text(size=18, face="bold" ), axis.title.y = element_text(size=18, face="bold"), axis.text.y = element_text(size = 18), axis.text.x = element_text(size = 18))
p2
...
p3 <- ggplot(UA_df, aes(x=baseline, y=CV*100)) +
  geom_point(size=2, shape=23, color="blue") +
  geom_smooth(color="blue", fill="blue")+
  ggtitle("WEF ranking vs Coefficient of Variance (CV)") + xlab("Baseline rank of WEF Index") + ylab("Coefficient of Variance (%)") + 
  theme_classic() + 
  theme(plot.title = element_text(size=18, face="bold", hjust = 0.5), axis.title.x = element_text(size=18, face="bold" ), axis.title.y = element_text(size=18, face="bold"), axis.text.y = element_text(size = 18), axis.text.x = element_text(size = 18))
p3
...
p4 <- ggplot(UA_df, aes(x=baseline, y=interval)) +
  geom_point(size=2, shape=23, color="red") +
  geom_smooth(color="red", fill="red") +
  ggtitle("WEF ranking vs Confidence Interval (CI)") + xlab("Baseline rank of WEF Index") + ylab("Confidence Inverval (95%)") + 
  theme_classic() + 
  theme(plot.title = element_text(size=18, face="bold", hjust = 0.5), axis.title.x = element_text(size=18, face="bold" ), axis.title.y = element_text(size=18, face="bold"), axis.text.y = element_text(size = 18), axis.text.x = element_text(size = 18))
p4
